  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="overflow-x-auto">
        <table className="w-full border-collapse table-fixed mt-6">
          <thead >
            <tr>
          ...
          <tbody className="divide-y divide-gray-300">
            ...
            <Link to={`/admin/candidates_per_offre/${offer._id}`}  key={index} >  <div  className="hover:bg-gray-100">
                <td className="px-6 py-4 whitespace-normal">{offer.titre}</td>
                <td className="px-6 py-4 whitespace-normal">{offer.domaine}</td>
                <td className="px-6 py-4 whitespace-normal">{offer.dateLimite}</td>
