...
function Home() {
  return (
<>
      <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-[#ff4d4d] text-white">
          ...
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-gray-200 md:text-xl">
                Our recruitment platform connects you with the best candidates for your open roles.
              </p>
            </div>
            <div>
