    ...
    <Navbar>
      <NavbarBrand>
        <Link >
          <img
            className="h-10"
            src="https://upload.wikimedia.org/wikipedia/commons/a/a8/Ooredoo_logo.svg"
            alt="Ooredoo Logo"
          />
        </Link>
      </NavbarBrand>
      ...
      {user.role != "admin" && (
        <NavbarContent className="hidden sm:flex gap-4" justify="center">
          ...
          {user?.role != "admin" && (
            <NavbarItem>
              <Link href="/alloffres">Offres de stages</Link>
            </NavbarItem>
          )}
          ...
          {user.role == "user" && (
            <NavbarItem>
              <Link href="/mescandidatures">Mes candidatures</Link>
            </NavbarItem>
          )}
